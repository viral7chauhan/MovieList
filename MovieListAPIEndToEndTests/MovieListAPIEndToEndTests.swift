//
//  MovieListAPIEndToEndTests.swift
//  MovieListAPIEndToEndTests
//
...
final class MovieListAPIEndToEndTests: XCTestCase {
    ...
    private func getResult(file: StaticString = #filePath, line: UInt = #line) -> RemoteMovieLoader.Result? {
        ...
        let loader = RemoteMovieLoader(url: testServerURL, client: client)
